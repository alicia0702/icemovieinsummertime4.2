...
import logo from '../assets/images/ice_movie_logo_1785176719378.jpg';
import photo1 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (1).png';
import photo2 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (2).png';
import photo3 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (3).png';
import photo4 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (4).png';
import photo5 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (5).png';
import photo6 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (6).png';
import photo7 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (7).png';
import photo8 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (8).png';
import photo9 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (9).png';
import photo10 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (10).png';
import photo11 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI (11).png';
import photo12 from '../assets/images/gallery/Copie a designului PARCUL DE AGREMENT TĂTĂRAȘI.png';
import CFF from '../assets/images/sponsors/logo.webp';
import ConsiliuSV from '../assets/images/sponsors/images.png';
import Provideo from '../assets/images/sponsors/images.jpg';
import expmusic from '../assets/images/sponsors/images (1).jpg';
...
const sponsorImages = {
  sp_suceava: ConsiliuSV,
  sp_expertmusic: expmusic,
  sp_provideo: Provideo,
  sp_cff: CFF,
};
...
export const AboutFestivalSection: React.FC<AboutFestivalSectionProps> = ({ driveFiles = [] }) => {
  ...
  useEffect(() => {
    const nextLogo = getMainLogoUrl(driveFiles) || logo;
    setLogoUrl(nextLogo);
  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        transition={{ duration: 0.6, ease: 'easeOut' }}
      >
        <PhotoGallerySection driveFiles={driveFiles} images={galleryImages} />
      </motion.div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.6, ease: 'easeOut' }}
      >
        <SponsorsSection driveFiles={driveFiles} sponsorImages={sponsorImages} images={Object.values(sponsorImages)} />
      </motion.div>
    </div>
  );
};
